...
urlpatterns = [
    ...
    url(r'^allRowPingTest/(?P<id>\d+)/$', csrf_exempt(views.allRowPingTest), name='allRowPingTest'),
    url(r'^delCCSRecord/(?P<id>\d+)/$', csrf_exempt(views.delCCSRecord), name='delCCSRecord'),
    url(r'^delONSRecord/(?P<id>\d+)/$', csrf_exempt(views.delONSRecord), name='delONSRecord'),
